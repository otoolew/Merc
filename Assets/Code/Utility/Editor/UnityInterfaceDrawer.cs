...
{   /// <summary>
    ...
    /// </summary>
    [CustomPropertyDrawer(typeof(UnityInterface), true)]
    public class UnityInterfaceDrawer : PropertyDrawer
    {
		/// <summary>
		...
		public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
		{
			...
			Type interfaceType = typeof(IUnityInterface);
		...
		static Type FindAncestorSerializableType(Type childType)
		{
			while (childType != null &&
				   ...
				   childType != typeof(UnityInterface<>))
			{
